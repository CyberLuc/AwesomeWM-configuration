...
--theme.taglist_bg_empty    = "png:" .. theme.un_icons .. "square_unsel.png"
--theme.taglist_bg_occupied = "png:" .. theme.icons .. "/panel/taglist/occupied.png"
--theme.taglist_bg_occupied = "png:" .. theme.un_icons .. "square_sel.png"
...
theme.taglist_squares_sel   = theme.icons .. "taglist/square_sel.png"
theme.taglist_squares_unsel = theme.icons .. "taglist/square_unsel.png"
theme.taglist_bg_focus    = "png:" .. theme.icons .. "taglist/taglist_bg_focus.png"
