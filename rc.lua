...
myawesomemenu = {
   ...
   { "Quit", awesome.quit },
   { "Logout", function() awful.util.spawn("systemctl reboot") end},
...
vicious.register(tdwidget, vicious.widgets.date, '<span font="Inconsolata 11" color="#AAAAAA" background="#1F2428"> %b %d %H:%M:%S </span>', 20)
...
'<span background="#313131" font="Inconsolata 11"> <span font="Inconsolata 11" color="#AAAAAA">${/home used_gb}/${/home size_gb} GB </span></span>', 800)
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ "Control", modkey}, "n", function() awful.util.spawn(browser .. " -incognito") end),
   awful.key({ "Control", modkey}, "e", function() awful.util.spawn(editor) end),
   awful.key({ "Control", modkey}, "d", function() awful.util.spawn("dbus-launch nautilus -w") end),
